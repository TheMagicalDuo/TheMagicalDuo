...
import { Check, Anchor, Map, Utensils, Building2, Car, HeartPulse, Package, X, ChevronRight, MessageCircle } from 'lucide-react'
        ...
        >
          ...
          <div className="p-7">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center justify-center gap-2.5 bg-bordeaux text-white px-6 py-3.5 rounded-full font-bold text-sm hover:bg-bordeaux/90 transition-colors shadow-md shadow-bordeaux/20"
            >
